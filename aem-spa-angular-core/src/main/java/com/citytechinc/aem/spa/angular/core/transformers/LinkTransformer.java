package com.citytechinc.aem.spa.angular.core.transformers;
...
public class LinkTransformer extends AbstractSAXPipe implements Transformer {
    ...
    public void init(ProcessingContext processingContext, ProcessingComponentConfiguration processingComponentConfiguration) throws IOException {
        ...
        if (WCMMode.PREVIEW.equals(currentMode) || WCMMode.DISABLED.equals(currentMode)) {
            if (requestedResource != null && (requestedResource.isResourceType(SinglePageApplication.RESOURCE_TYPE) || requestedResource.isResourceType(SinglePageApplicationState.RESOURCE_TYPE))) {
                transform = true;
            }
        }
    }
    ...
    private String transformHref(String href) {
        ...
        SinglePageApplicationState referencedState = referencedResource.adaptTo(SinglePageApplicationState.class);
